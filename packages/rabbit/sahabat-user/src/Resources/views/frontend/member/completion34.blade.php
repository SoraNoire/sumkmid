...
<div class="breadcrumb">
	<div class="container">
		<h2><a href="{{ route('public_home') }}">Beranda</a> <i class="fa fa-angle-right" aria-hidden="true"></i>Lengkapi data</h2>
	</div>
</div>
<?php
?>
	...
	@endif
		...
		<div class="rightForm ">
			...
			<div class="formGroup {{ (session('warnName') == 'nomorTelepon') ? 'withError' : '' }}">
				...
				@endif
				<div class="inputText">
					<input type="text" name="nomorTelepon" id="" value="{{$user->phone_number}}">
				</div>
			</div>
