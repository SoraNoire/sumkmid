...
@endif
<form method="post" action="{{ URL::to('blog/bulk-delete-tag/')}}" accept-charset="UTF-8">
    <a href="{{ URL::to('blog/create-tag') }}" class="btn btn-round btn-fill btn-info">New Tag +<div class="ripple-container"></div></a>
...
<div class="card">
    ...
    <div class="card-content table-responsive">
        <table class="table mydatatable" id="TagTable">
            <thead>
                <th>Name</th>
                <th>Created At</th>
                <th>Action</th>
