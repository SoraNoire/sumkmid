...
<form class="pull-right" method="post" action="{{ URL::to('blog/bulk-delete-media/')}}" accept-charset="UTF-8">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    <input type="hidden" name="id" class="bulk-delete-id">
    <button type="sumbit" style="display: none;margin-bottom: 10px;" class="btn btn-round btn-fill btn-danger bulk-delete-item">Delete <span class="bulk-delete-count"></span> Post</button>
</form>
...
<div class="card">
    ...
    <div class="table-overlay">Processing...</div>
        <table class="table mydatatable mediatable" id="MediaTable">
            <thead>
                <th>Preview</th>
                <th>Name</th>
                <th>Created At</th>
