...
<form method="post" action="{{ URL::to($prefix.'bulk-delete-category/')}}" accept-charset="UTF-8">
    ...
    <button type="sumbit" style="display: none;" class="btn btn-round btn-fill btn-danger bulk-delete-item">Delete <span id="delete-count"></span> Category</button>
</form>
<div class="card">
    ...
    <div class="card-content table-responsive">
        <table class="table mydatatable" id="GalleryCategoryTable">
            <thead>
                <th>Name</th>
                <th>Created At</th>
                <th>Action</th>
