...
<div class="breadcrumb">
	<div class="container">
		<h2><a href="{{ route('public_home') }}">Home</a> <i class="fa fa-angle-right" aria-hidden="true"></i>Tentang Kami</h2>
	</div>
</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-12 tentangContent">
				...
				<p>Dengan latar belakang itulah komunitas Sahabat UMKM dibentuk sebagai komunitas yang mempertemukan antara Pelaku UMKM dan Profesional Kewirausahaan. Dengan prinsip komunikasi positif dan saling membangun, Sahabat UMKM menjadi sarana penyampaian ilmu dan wadah interaksi bagi para pelaku usaha untuk saling berkontribusi, menyampaikan pemikiran, dan berbagi pengalaman dalam membangun serta mengembangkan jaringan usaha.</p>
				<h4>VISI</h4>
