...
<div class="breadcrumb">
	<div class="container">
		<h2><a href="{{ route('public_home') }}">Home</a> <i class="fa fa-angle-right" aria-hidden="true"></i><a href="{{ route('public_mentor') }}">Mentor</a><i class="fa fa-angle-right" aria-hidden="true"></i>{{$var['mentors']->name}}</h2>
	</div>
</div>
